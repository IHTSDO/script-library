...
public class INFRA9607_RetermMeasurementFindings extends BatchFix {
	...
	protected INFRA9607_RetermMeasurementFindings(BatchFix clone) throws TermServerScriptException {
		super(clone);
	...
	public static void main(String[] args) throws TermServerScriptException {
		new INFRA9607_RetermMeasurementFindings(null).standardExecution(args, ExecutionOptions.DEFAULT);
	}
	...
	private int modifyDescriptions(Task t, Concept c, boolean usgbVariance) throws TermServerScriptException {
		...
		if (patternOfX.equals(Pattern.CHECK_PT_ONLY)) {
			...
			report(t, c, Severity.HIGH, ReportActionType.VALIDATION_CHECK, "Pattern Y with/and X, 'borderline' or 'risk' requires manual intervention");
			return NO_CHANGES_MADE;
		}
