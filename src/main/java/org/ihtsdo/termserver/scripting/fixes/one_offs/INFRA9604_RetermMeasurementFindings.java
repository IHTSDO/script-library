...
public class INFRA9604_RetermMeasurementFindings extends BatchFix {
	...
	protected INFRA9604_RetermMeasurementFindings(BatchFix clone) throws TermServerScriptException {
		super(clone);
	...
	public static void main(String[] args) throws TermServerScriptException {
		new INFRA9604_RetermMeasurementFindings(null).standardExecution(args, ExecutionOptions.DEFAULT);
	}
