...
public class INFRA9608_RetermMeasurementFindings extends BatchFix {
	...
	protected INFRA9608_RetermMeasurementFindings(BatchFix clone) throws TermServerScriptException {
		super(clone);
	...
	public static void main(String[] args) throws TermServerScriptException {
		new INFRA9608_RetermMeasurementFindings(null).standardExecution(args, ExecutionOptions.DEFAULT);
	}
